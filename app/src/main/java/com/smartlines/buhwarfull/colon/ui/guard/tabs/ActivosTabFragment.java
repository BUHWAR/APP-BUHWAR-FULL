package com.smartlines.buhwarfull.colon.ui.guard.tabs;
...
import com.smartlines.buhwarfull.colon.adapter.GuardAdapater;
...
public class ActivosTabFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View root = (View) inflater.inflate(R.layout.fragment_activos, container, false);
    ...
    public void fillAdapter(List<GuardModel> list) {
        adapter = new GuardAdapater(list, getActivity());
